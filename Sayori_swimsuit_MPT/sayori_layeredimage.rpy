...
layeredimage sayori turned: 
    ...
    always "mod_assets/MPT/sayori/sayori_turned_facebase.png" if_not(["swimsuit"])
    ...
    group mouth:
        ...
        ###EXAMPLE OF USAGE: show sayori turned swimsuit happ mouth1 at t11
        attribute mouth1:
            path + "mouths/mouth1.png"
        attribute mouth2:
            path + "mouths/mouth2.png"
    ...
    group special:
        ...
        attribute s_scream if_any(["swimsuit"]):
            path + "scream.png"
...
layeredimage sayori tap: #tapping definitions.
    ...
    group outfit:
        attribute uniform default if_not(["swimsuit"]):
            "mod_assets/MPT/sayori/sayori_tapping_uniform_bodybase.png"
        attribute casual if_not(["swimsuit"]):
            "mod_assets/MPT/sayori/sayori_tapping_casual_bodybase.png"
        attribute swimsuit default if_any(["swimsuit"]):
            path + "body/c3a.png"
    
    always "mod_assets/MPT/sayori/sayori_tapping_facebase.png" if_not(["swimsuit"])
