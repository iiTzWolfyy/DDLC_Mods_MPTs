...
layeredimage natsuki turned:
    ...
    group left: #Left arm.
        ...
        ###ADD
        attribute lhip if_any(["swimsuit"]):
            path + "body/2l.png"
    ...
    group head: #This needs to render above her body for her "turned" pose.
        ...
        ###EDIT THIS LINE
        attribute ff default if_not(["swimsuit"]):
        ...
        ###ADD
        attribute swim default if_all(["swimsuit"]):
            path + "facebase.png"
    
    
    
    
    ###EDIT THIS LINE SO THAT YOU HAVE 'if_any(["ff", "swimsuit"])' instead of 'if_all(["ff"])'
    group nose if_any(["ff", "swimsuit"]) if_not(["fta","fs"]):
    ...
    ###EDIT THIS LINE SO THAT YOU HAVE 'if_any(["ff", "swimsuit"])' instead of 'if_all(["ff"])'
    group mouth if_any(["ff", "swimsuit"]) if_not(["fta","fs"]):
    ...
    ###EDIT THIS LINE SO THAT YOU HAVE 'if_any(["ff", "swimsuit"])' instead of 'if_all(["ff"])'
    group eyes if_any(["ff", "swimsuit"]) if_not(["fta","fs"]):
        ...
        ###ADD THOSE TWO EXTRA EYES (if you wanna use them). For example, in code:
        ###show natsuki turned swimsuit lup eyes1 at t11
        ###Be aware that those eyes may not work with some eyebrows for example.
        attribute eyes1:
            path + "extra_eyes/extra_eyes.png"
        attribute eyes2:
            path + "extra_eyes/extra_eyes2.png"
    
    
    ###EDIT THIS LINE SO THAT YOU HAVE 'if_any(["ff", "swimsuit"])' instead of 'if_all(["ff"])'
    group eyebrows if_any(["ff", "swimsuit"]) if_not(["fta","fs"]): #eyebrows.
    ...
    ###EDIT THIS LINE SO THAT YOU HAVE 'if_any(["ff", "swimsuit"])' instead of 'if_all(["ff"])'
    group eyebrows if_any(["ff", "swimsuit"]) if_not(["fta","fs"]):
    ...
    group special if_any(["ff", "swimsuit"]) if_not(["fta","fs"]):
        
        anchor (0,0) subpixel (True)
        
        attribute s_scream if_not(["swimsuit"]):
            "mod_assets/MPT/natsuki/natsuki_face_special_scream.png"
        attribute s_scream if_all(["swimsuit"]):
            path + "scream.png"
