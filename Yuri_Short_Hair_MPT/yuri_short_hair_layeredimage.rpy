...
init python:
    #Just change this variable to match your files path if you need!
    base_path = "mod_assets/MPT/Yuri_Short_Hair_MPT/"
...
image _yuri_blink_b:
    ...
    choice:
        alpha 1.0
        base_path + "turned_blink/yuri_turned_eyes_blink1.png"
        0.015
        base_path + "turned_blink/yuri_turned_eyes_blink2.png"
        0.035
        base_path + "turned_blink/yuri_turned_eyes_blink1.png"
        0.015
    choice:
...
image _yuri_blink_s_b:
    ...
    choice:
        alpha 1.0
        base_path + "shy_blink/yuri_blink_shy1.png"
        0.015
        base_path + "shy_blink/yuri_blink_shy2.png"
        0.035
        base_path + "shy_blink/yuri_blink_shy1.png"
        0.015
    choice:
...
layeredimage yuri short hair turned:
    ...
    always base_path + "turned_base/uniform/yuri_turned_facebase.png" if_not(["casual"])

    always base_path + "turned_base/casual/yuri_turned_facebase.png" if_any(["casual"])
    ...
    group right:
        ...
        attribute rdown default if_any(["uniform"]):
            base_path + "turned_base/uniform/rdown.png"
        attribute rup if_any(["uniform"]):
            base_path + "turned_base/uniform/rup.png"
        attribute rcut if_any(["uniform"]):
            base_path + "turned_base/uniform/cuts.png"
        attribute rcuts_deep if_any(["uniform"]): 
            base_path + "turned_base/uniform/deep_cuts.png"
        attribute rolled_up_cuts if_any(["uniform"]):
            base_path + "turned_base/uniform/cuts_rolled_up.png"
        attribute rbandages if_any(["uniform"]):
            base_path + "turned_base/uniform/bandages.png"
        attribute rolled_up_bandages if_any(["uniform"]):
            base_path + "turned_base/uniform/bandages_rolled_up.png"
        attribute rhealed if_any(["uniform"]):
            base_path + "turned_base/uniform/healed.png"
        
        
        #CASUAL
        attribute rdown default if_any(["casual"]):
            base_path + "turned_base/casual/rdown.png"
        attribute rup if_any(["casual"]):
            base_path + "turned_base/casual/rup.png"
        attribute rcut if_any(["casual"]):
            base_path + "turned_base/casual/cuts.png"
        attribute rcuts_deep if_any(["casual"]):
            base_path + "turned_base/casual/deep_cuts.png"
        attribute rolled_up_cuts if_any(["casual"]):
            base_path + "turned_base/casual/cuts_rolled_up.png"
        attribute rbandages if_any(["casual"]):
            base_path + "turned_base/casual/bandages.png"
        attribute rolled_up_bandages if_any(["casual"]):
            base_path + "turned_base/casual/bandages_rolled_up.png"
        attribute rhealed if_any(["casual"]):
            base_path + "turned_base/casual/healed.png"
    ...
    group mouth:
        ...
        attribute cm default if_any(["happ","laug"]):
            base_path + "turned_mouth/yuri_turned_mouth_ma.png"
        attribute cm default if_any(["neut","lsur","worr"]):
            base_path + "turned_mouth/yuri_turned_mouth_md.png"#
        attribute cm default if_any(["sedu"]):
            base_path + "turned_mouth/yuri_turned_mouth_me.png"
        attribute cm default if_any(["pout","curi"]):
            base_path + "turned_mouth/yuri_turned_mouth_mf.png"
        attribute cm default if_any(["shoc"]):
            base_path + "turned_mouth/yuri_turned_mouth_mg.png"
        attribute cm default if_any(["dist","anno","vsur","sad","angr","cry","doub"]):
            base_path + "turned_mouth/yuri_turned_mouth_mj.png"
        attribute cm default if_any(["nerv","flus"]):
            base_path + "turned_mouth/yuri_turned_mouth_mk.png"
        attribute cm default if_any(["vang","pani"]):
            base_path + "turned_mouth/yuri_turned_mouth_mm.png"
        attribute cm default if_any(["yand"]):
            base_path + "turned_mouth/yuri_turned_mouth_mo.png"

        #Open Mouths:
        attribute om if_any(["happ"]):
            base_path + "turned_mouth/yuri_turned_mouth_mb.png"
        attribute om if_any(["laug","nerv","yand"]):
            base_path + "turned_mouth/yuri_turned_mouth_mc.png"
        ...
        attribute om if_any(["neut","anno","vsur","curi"]):
            base_path + "turned_mouth/yuri_turned_mouth_mh.png"
        attribute om if_any(["flus","doub"]):
            base_path + "turned_mouth/yuri_turned_mouth_mi.png"
        attribute om if_any(["sad"]):
            base_path + "turned_mouth/yuri_turned_mouth_mk.png"                  
        attribute om if_any(["vang","shoc","pani"]):
            base_path + "turned_mouth/yuri_turned_mouth_ml.png"
        ...
        attribute mm:
            base_path + "turned_mouth/yuri_turned_mouth_mm.png"
        attribute mn:
            base_path + "turned_mouth/yuri_turned_mouth_mn.png"
        attribute mo:
            base_path + "turned_mouth/yuri_turned_mouth_mo.png"
        attribute mp:
            base_path + "turned_mouth/yuri_turned_mouth_mp.png"
        attribute mq:
            base_path + "turned_mouth/yuri_turned_mouth_mq.png"
        attribute mr:
            base_path + "turned_mouth/yuri_turned_mouth_mr.png"
    ...
    group eyes:
        ...
        attribute oe default if_any(["neut","sedu"]):
            base_path + "turned_eyes/yuri_turned_eyes_e1a.png"
        attribute oe default if_any(["dist","worr"]):
            base_path + "turned_eyes/yuri_turned_eyes_e1b.png"
        attribute oe default if_any(["happ","angr","pout","curi"]):
            base_path + "turned_eyes/yuri_turned_eyes_e1d.png"
        attribute oe default if_any(["cry"]):
            base_path + "turned_eyes/yuri_turned_eyes_e1h.png"
        attribute oe default if_any(["lsur","vang"]):
            base_path + "turned_eyes/yuri_turned_eyes_e2a.png"
        attribute oe default if_any(["anno","flus","laug","sad"]):
            base_path + "turned_eyes/yuri_turned_eyes_e2b.png"
        attribute oe default if_any(["nerv","doub"]):
            base_path + "turned_eyes/yuri_turned_eyes_e2c.png"
        attribute oe default if_any(["shoc","pani","vsur"]):
            base_path + "turned_eyes/yuri_turned_eyes_e2d.png"
        attribute oe default if_any(["yand"]):
            base_path + "turned_eyes/yuri_turned_eyes_e3a.png"

        #Default Closed eyes:
        attribute ce if_any(["dist","anno","vang","flus","lsur","shoc","vsur","worr","sad","angr","nerv","curi","doub"]):
            base_path + "turned_eyes/yuri_turned_eyes_e4a.png"
        attribute ce if_any(["neut","happ","yand","pani","laug","sedu","pout"]):
            base_path + "turned_eyes/yuri_turned_eyes_e4b.png"
        attribute ce if_any(["cry"]):
            base_path + "turned_eyes/yuri_turned_eyes_e4e.png"
        ...
        attribute e1b:
            base_path + "turned_eyes/yuri_turned_eyes_e1b.png"
        attribute e1c:
            base_path + "turned_eyes/yuri_turned_eyes_e1c.png"
        attribute e1d:
            base_path + "turned_eyes/yuri_turned_eyes_e1d.png"
        attribute e1e:
            base_path + "turned_eyes/yuri_turned_eyes_e1e.png"
        attribute e1f:
            base_path + "turned_eyes/yuri_turned_eyes_e1f.png"
        attribute e1g:
            base_path + "turned_eyes/yuri_turned_eyes_e1g.png"
        attribute e1h:
            base_path + "turned_eyes/yuri_turned_eyes_e1h.png"
        attribute e2a:
            base_path + "turned_eyes/yuri_turned_eyes_e2a.png"
        ...
        attribute e3a:
            base_path + "turned_eyes/yuri_turned_eyes_e3a.png"
        attribute e3b:
            base_path + "turned_eyes/yuri_turned_eyes_e3b.png"
        attribute e4a:
            base_path + "turned_eyes/yuri_turned_eyes_e4a.png"
        attribute e4b:
            base_path + "turned_eyes/yuri_turned_eyes_e4b.png"
        attribute e4c:
            base_path + "turned_eyes/yuri_turned_eyes_e4c.png"
        attribute e4d:
            base_path + "turned_eyes/yuri_turned_eyes_e4d.png"
        attribute e4e:
            base_path + "turned_eyes/yuri_turned_eyes_e4e.png"
        attribute e0a:
            base_path + "turned_eyes/yuri_turned_eyes_e0a.png"
        attribute e0b:
            base_path + "turned_eyes/yuri_turned_eyes_e0b.png"
        attribute ela:
            base_path + "turned_eyes/yuri_turned_eyes_ela.png"
        attribute elb:
            base_path + "turned_eyes/yuri_turned_eyes_elb.png"
    ...
    group eyebrows:
        ...
        attribute brow default if_any(["neut"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b1a.png"
        attribute brow default if_any(["flus","lsur","laug"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b1b.png"
        attribute brow default if_any(["dist","sedu"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b1c.png"
        attribute brow default if_any(["anno"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b1d.png"
        attribute brow default if_any(["vang","angr"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b1e.png"
        attribute brow default if_any(["curi","doub"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b1f.png"
        attribute brow default if_any(["happ"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b2a.png"
        attribute brow default if_any(["worr","sad","nerv","cry"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b2b.png"
        attribute brow default if_any(["yand","shoc","vsur","pani"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b2c.png"
        attribute brow default if_any(["pout"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b3b.png"
        ...
        attribute b3a if_not(["e0b","e2d","e3a","e3b","shoc","pani","vsur","yand"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b3a.png"
        attribute b3b if_not(["e0b","e2d","e3a","e3b","shoc","pani","vsur","yand"]):
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b3b.png"
        attribute b3c:
            base_path + "turned_eyebrows/yuri_turned_eyebrows_b3c.png"
    ...
    group special:
        ...
        attribute scream:
            base_path + "turned_scream/yuri_turned_scream.png"
...
layeredimage yuri short hair shy:
    ...
    always base_path + "shy_base/yuri_base_shy_uniform.png" if_not(["casual"])

    always base_path + "shy_base/yuri_base_shy_casual.png" if_any(["casual"])
    ...
    group nose:
        ...
        #Default nose/blush.
        attribute nose default if_any(["nobl"]):#default nose
            base_path + "shy_nose/yuri_shy_nose_n1.png"
        attribute nose default if_any(["awkw"]):#default nose when "awkward"
            base_path + "shy_nose/yuri_shy_nose_n2.png"
        attribute nose default if_any(["blus"]):#default nose when "blushing"
            base_path + "shy_nose/yuri_shy_nose_n3.png"
        attribute nose default if_any(["blaw"]):#default nose when "blushing" and "awkward"
            base_path + "shy_nose/yuri_shy_nose_n4.png"
        attribute nose default if_any(["bful"]):#Full face blush
            base_path + "shy_nose/yuri_shy_nose_n5.png"
    ...
    group mouth:
        ...
        attribute cm default if_any(["neut"]):
            base_path + "shy_mouth/yuri_shy_mouth_m1.png"
        attribute cm default if_any(["angr","sad"]):
            base_path + "shy_mouth/yuri_shy_mouth_m2.png"
        attribute cm default if_any(["happ"]):
            base_path + "shy_mouth/yuri_shy_mouth_m3.png"

        #default open mouth.  As of this writing...she only has one open mouth.
        attribute om:
            base_path + "shy_mouth/yuri_shy_mouth_m4.png"
    ...
    group eyes if_not(["n5","bful"]): #Cannot show if full-face blush is present.
        ...
        attribute oe default if_any(["happ"]):
            base_path + "shy_eyes/yuri_shy_eyes_e1.png"
        attribute oe default if_any(["neut"]):
            base_path + "shy_eyes/yuri_shy_eyes_e2.png"
        attribute oe default if_any(["angr"]):
            base_path + "shy_eyes/yuri_shy_eyes_e3.png"
        attribute oe default if_any(["sad"]):
            base_path + "shy_eyes/yuri_shy_eyes_e4.png"

        #Closed eyes
        attribute ce if_any(["angr","neut","happ"]):
            base_path + "shy_eyes/yuri_shy_eyes_e5.png"
        attribute ce if_any(["sad"]):
            base_path + "shy_eyes/yuri_shy_eyes_e6.png"
    ...
    group eyebrows if_not(["n5","bful"]): #Cannot show if full-face blush is present.
        ...
        attribute brow default if_any(["happ"]):
            base_path + "shy_eyebrows/yuri_shy_eyebrows_b1.png"
        attribute brow default if_any(["neut","sad"]):
            base_path + "shy_eyebrows/yuri_shy_eyebrows_b2.png"
        attribute brow default if_any(["angr"]):
            base_path + "shy_eyebrows/yuri_shy_eyebrows_b3.png"
